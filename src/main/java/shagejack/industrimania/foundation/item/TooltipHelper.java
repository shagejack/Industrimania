...
import shagejack.industrimania.content.contraptions.goggles.IHaveGoggleInformation;
...
//			format = TextFormatting.getFormatString(formattedLine);
    ...
    public static boolean hasTooltip(ItemStack stack, Player player) {
        ...
        boolean hasGlasses = GogglesItem.isIn(player.getItemBySlot(EquipmentSlot.HEAD));
