...
import static shagejack.minecraftology.util.MCLBlockHelper.RotationType;
import static shagejack.minecraftology.util.MCLBlockHelper.SIDE_LEFT;

import javax.annotation.Nonnull;

public class MCLBlock extends Block implements ItemModelProvider {
    ...
    private MCLBlockHelper.RotationType rotationType;

    public MCLBlock(Material material, String name) {
        super(material);
        ...
        rotationType = MCLBlockHelper.RotationType.FOUR_WAY;
    }
    ...
    public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
        ...
        MCLTileEntity tileEntity = (MCLTileEntity) worldIn.getTileEntity(pos);
        if (tileEntity != null) {
    ...
    public void neighborChanged(IBlockState state, World world, BlockPos pos, Block blockIn, BlockPos neighbor) {
        ...
        MCLTileEntity tileEntity = (MCLTileEntity) world.getTileEntity(pos);
        if (tileEntity != null) {
    ...
    public void breakBlock(World worldIn, BlockPos pos, IBlockState state) {
        if (hasTileEntity(state) && worldIn.getTileEntity(pos) != null && worldIn.getTileEntity(pos) instanceof MCLTileEntity) {
            ((MCLTileEntity) worldIn.getTileEntity(pos)).onDestroyed(worldIn, pos, state);
        }
