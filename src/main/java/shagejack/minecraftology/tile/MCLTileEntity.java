...
public abstract class MCLTileEntity extends TileEntity implements IMCLTileEntity {
    public MCLTileEntity() {
        super();
    }

    public MCLTileEntity(World world, int meta) {
        super();
    }
    ...
    public void sendNBTToServer(EnumSet<MachineNBTCategory> categories, boolean forceUpdate, boolean sendDisk) {
        if (world.isRemote) {
            Minecraftology.NETWORK.sendToServer(new PacketSendMachineNBT(categories, this, forceUpdate, sendDisk));
        }
    }
