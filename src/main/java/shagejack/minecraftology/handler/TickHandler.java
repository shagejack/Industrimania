...
import shagejack.minecraftology.tile.IMCLTickable;
...
public class TickHandler {
    ...
    public void onWorldTick(TickEvent.WorldTickEvent event) {
        ...
        if (event.side.isServer()) {
            FMLCommonHandler.instance().getMinecraftServerInstance().profiler.startSection("MCL WorldTick Tiles");
            ...
            for (int i = 0; i < tileEntityListSize; i++) {
                try {
                    ...
                    if (tileEntity instanceof IMCLTickable) {
        ...
        //Minecraftology.MCL_WORLD.onWorldTick(event);
    }
