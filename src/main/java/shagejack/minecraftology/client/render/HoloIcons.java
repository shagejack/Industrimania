package shagejack.minecraftology.client.render;
...
import shagejack.minecraftology.client.TextureMapMCL;
...
public class HoloIcons implements ITextureMapPopulator {
    public final TextureMapMCL textureMap;
    ...
    public HoloIcons() {
        iconMap = new HashMap<>();
        textureMap = new TextureMapMCL("textures/gui/items", this);
        ...
        try {
            ...
            LogMCL.log(Level.ERROR, e, "There was a problem while creating Holo Icons texture sheet");
        }
    }
