...
public class TextureMapMCL extends TextureMap {

    public TextureMapMCL(String basePathIn) {
        super(basePathIn);
    }

    public TextureMapMCL(String basePathIn, @Nullable ITextureMapPopulator iconCreatorIn) {
        super(basePathIn, iconCreatorIn);
    }

    public TextureMapMCL(String basePathIn, boolean skipFirst) {
        super(basePathIn, skipFirst);
    }

    public TextureMapMCL(String basePathIn, @Nullable ITextureMapPopulator iconCreatorIn, boolean skipFirst) {
    ...
    public void loadTextureAtlas(IResourceManager resourceManager) {
        ...
        LogMCL.info("Created: %dx%d %s-atlas", stitcher.getCurrentWidth(), stitcher.getCurrentHeight(), this.basePath);
    ...
    private boolean generateMipmaps(IResourceManager resourceManager, final TextureAtlasSprite texture) {
        ...
        label9:
        {
            ...
            try {
                ...
                LogMCL.error("Unable to parse metadata from {}", resourcelocation, runtimeexception);
                flag = false;
            } catch (IOException ioexception) {
                LogMCL.error("Using missing texture, unable to load {}", resourcelocation, ioexception);
                flag = false;
                return flag;
            } finally {
                IOUtils.closeQuietly(iresource);
