package shagejack.minecraftology.client.model;
...
public class MCLModelLoader implements ICustomModelLoader {
    ...
    public static class MOModelRegistryEvent extends Event {
        private final MCLModelLoader loader;
        private final Map<ResourceLocation, IModel> models;
        private final Type type;

        public MOModelRegistryEvent(MCLModelLoader loader, Map<ResourceLocation, IModel> models, Type type) {
            this.loader = loader;
            this.models = models;
            this.type = type;
        }

        public MCLModelLoader getLoader() {
            return loader;
        }
        ...
        public static class Block extends MOModelRegistryEvent {
            public Block(MCLModelLoader loader, Map<ResourceLocation, IModel> models) {
                super(loader, models, Type.BLOCK);
            }
        }

        public static class Item extends MOModelRegistryEvent {
            public Item(MCLModelLoader loader, Map<ResourceLocation, IModel> models) {
