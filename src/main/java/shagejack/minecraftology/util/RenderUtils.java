...
public class RenderUtils {
    ...
    public static void rotateFromBlock(World world, BlockPos pos) {
        if (world != null) {
            ...
            EnumFacing rotation = blockState.getValue(MCLBlock.PROPERTY_DIRECTION);
    ...
    public static void beginDrawinngBlockScreen(double x, double y, double z, EnumFacing side, Color color, TileEntity entity, double offset, float glowAlpha) {
        ...
        float multiply = (float) (MCLMathHelper.noise(entity.getPos().getX(), entity.getWorld().getWorldTime() * 0.01, entity.getPos().getZ()) * 0.5 + 0.5) * glowAlpha;
