...
import shagejack.minecraftology.gui.events.IListHandler;
...
public abstract class MCLGuiBase extends GuiContainer implements IButtonHandler, ITextHandler, IListHandler, GuiElementList {
    ...
    protected List<MCLElementButton> pageButtons;
    protected ArrayList<MCLElementBase> elements;
    ...
    public MCLGuiBase(MCLBaseContainer container) {
        this(container, 225, 186);

    }

    public MCLGuiBase(MCLBaseContainer container, int width, int height) {
        super(container);
    ...
    public void initGui() {
        ...
        for (MCLElementButton button : pageButtons) {
    ...
    public void addTooltips(List<String> list) {
        for (int i = elements.size(); i-- > 0; ) {
            ...
            if (element instanceof MCLElementBase && element.isVisible() && element.intersectsWith(mouseX, mouseY)) {
    ...
    public void handleMouseInput() throws IOException {
        ...
        if (var3 != 0) {
            ...
            while (var4-- > 0) {
                MCLElementBase var5 = this.elements.get(var4);
    ...
    protected void updateElementInformation() {
        ...
        for (int i = elements.size(); i-- > 0; ) {
            if (elements.get(i) instanceof MCLElementBase) {
    ...
    protected final void updateElements(float partialTicks) {
        ...
        while (elementCount-- > 0) {
            MCLElementBase element = this.elements.get(elementCount);
    ...
    public void registerPages(MCLBaseContainer container) {
    }
    ...
    public MCLElementIconButton AddPage(ElementBaseGroup page, HoloIcon icon, String tooltip) {
        pages.add(page);
        MCLElementIconButton button = new MCLElementIconButton(this, this, 0, 0, page.getName(), 0, 0, 24, 0, 24, 0, 24, 24, "", icon);
    ...
    public MCLBaseContainer getContainer() {
