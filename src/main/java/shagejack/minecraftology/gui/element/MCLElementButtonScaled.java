...
public class MCLElementButtonScaled extends MCLElementButton {
    ...
    public MCLElementButtonScaled(MCLGuiBase gui, IButtonHandler handler, int posX, int posY, String name, int sizeX, int sizeY) {
