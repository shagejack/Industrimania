...
import shagejack.minecraftology.data.ScaleTexture;
...
public class MCLElementTextField extends MCLElementBase {
    ...
    public MCLElementTextField(MCLGuiBase gui, ITextHandler textHandler, int posX, int posY, int width, int height) {
        this(gui, textHandler, posX, posY, width, height, (short) 32);
    }

    public MCLElementTextField(MCLGuiBase gui, ITextHandler textHandler, int posX, int posY, int width, int height, short limit) {
    ...
    public MCLElementTextField(MCLGuiBase gui, int posX, int posY, int width, int height) {
        this(gui, gui, posX, posY, width, height);
    }

    public MCLElementTextField(MCLGuiBase gui, int posX, int posY, int width, int height, short limit) {
        this(gui, gui, posX, posY, width, height, limit);
    }

    public MCLElementTextField setTextColor(Number textColor, Number selectedTextColor) {
    ...
    public MCLElementTextField setSelectionColor(Number selectedLineColor, Number defaultCaretColor) {
    ...
    public MCLElementTextField setBackgroundColor(Number backgroundColor, Number disabledColor, Number borderColor) {
    ...
    public MCLElementTextField setMultiline(boolean multi) {
    ...
    public MCLElementTextField setFocused(boolean focused) {
    ...
    public MCLElementTextField setFocusable(boolean focusable) {
    ...
    public MCLElementTextField setText(String text) {
    ...
    public MCLElementTextField setMaxLength(short limit) {
            ...
            default:
                switch (keyTyped) {
                    ...
                    case Keyboard.KEY_RIGHT: // right arrow
                        ...
                        } else if (MCLStringHelper.isAltKeyDown() && GuiScreen.isShiftKeyDown()) {
    ...
    public MCLElementTextField setFilter(Pattern pattern, boolean includeVanilla) {
