...
public class ElementCheckbox extends MCLElementButtonScaled {
    String checkboxLabel;
    boolean state;

    public ElementCheckbox(MCLGuiBase gui, IButtonHandler handler, int posX, int posY, String name, boolean state) {
        super(gui, handler, posX, posY, name, 16, 16);
        this.state = state;
        setNormalTexture(MCLElementButtonScaled.HOVER_TEXTURE_DARK);
    }
