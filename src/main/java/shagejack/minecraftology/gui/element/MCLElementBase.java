...
public abstract class MCLElementBase {
    protected final MCLGuiBase gui;
    public MCLElementBase parent;
    ...
    public MCLElementBase(MCLGuiBase gui, int posX, int posY) {
        this.gui = gui;
        this.posX = posX;
        this.posY = posY;
    }

    public MCLElementBase(MCLGuiBase gui, int posX, int posY, int width, int height) {
        this.gui = gui;
        this.posX = posX;
        this.posY = posY;
        this.sizeX = width;
    ...
    public MCLElementBase setPosition(int var1, int var2) {
        this.posX = var1;
        this.posY = var2;
        return this;
    }

    public MCLElementBase setSize(int var1, int var2) {
        this.sizeX = var1;
        this.sizeY = var2;
        return this;
    }

    public MCLElementBase setTexture(String var1, int var2, int var3) {
    ...
    public final MCLElementBase setVisible(boolean var1) {
        this.visible = var1;
        return this;
    }
    ...
    public final MCLElementBase setEnabled(boolean var1) {
        this.enabled = var1;
        return this;
    }
    ...
    public MCLElementBase setFontRenderer(FontRenderer var1) {
    ...
    public MCLElementBase setName(String var1) {
        this.name = var1;
        return this;
    }

    public final MCLGuiBase getContainerScreen() {
        return this.gui;
    }
