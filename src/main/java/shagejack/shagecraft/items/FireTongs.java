...
public class FireTongs extends ShageBaseItem implements IToolFireTongs {
    ...
    public void addDetails(ItemStack itemstack, EntityPlayer player, @Nullable World worldIn, List<String> infos) {
        ...
        if(getHasItem(itemstack)) {
            ...
            infos.add("\u6742\u8d28(Impurities): " + ShageStringHelper.formatNumber(getImpurities(itemstack)) + "g");
            infos.add("\u78b3\u542b\u91cf(Carbon): " + ShageStringHelper.formatNumber(getCarbon(itemstack) * 100) + "%");
            infos.add("\u6e29\u5ea6(Temp): " + ShageStringHelper.formatNumber(getTemp(itemstack)) + "K");
            infos.add("===== \u5f62\u72b6 Shape =====");
    ...
    public boolean canFireTongs(ItemStack itemstack){
        ...
        if (item == Shagecraft.ITEMS.fire_tongs) {
