...
public class ElementIntegerField extends ElementBaseGroup implements IButtonHandler {
    ...
    private ShageElementButtonScaled incBtn;
    private ShageElementButtonScaled decBtn;
    ...
    public ElementIntegerField(ShageGuiBase gui, IButtonHandler buttonHandler, int posX, int posY, int height, int min, int max) {
    ...
    public ElementIntegerField(ShageGuiBase gui, IButtonHandler buttonHandler, int posX, int posY, int width, int height, int min, int max) {
        ...
        incBtn = new ShageElementButtonScaled(gui, this, 0, 0, "Inc", 16, height);
        ...
        decBtn = new ShageElementButtonScaled(gui, this, width - 16, 0, "Dec", 16, height);
    ...
    public ElementIntegerField(ShageGuiBase gui, IButtonHandler buttonHandler, int posX, int posY, int width, int height) {
        this(gui, buttonHandler, posX, posY, width, height, Integer.MIN_VALUE, Integer.MAX_VALUE);
    }

    public ElementIntegerField(ShageGuiBase gui, IButtonHandler buttonHandler, int posX, int posY) {
