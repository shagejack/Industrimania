...
public class ShageElementButtonScaled extends ShageElementButton {
    ...
    public ShageElementButtonScaled(ShageGuiBase gui, IButtonHandler handler, int posX, int posY, String name, int sizeX, int sizeY) {
