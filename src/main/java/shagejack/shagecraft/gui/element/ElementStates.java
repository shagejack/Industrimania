...
public class ElementStates extends ShageElementButtonScaled {
    String[] states;
    int selectedState;
    String label;

    public ElementStates(ShageGuiBase gui, IButtonHandler buttonHandler, int posX, int posY, String name, String[] states) {
