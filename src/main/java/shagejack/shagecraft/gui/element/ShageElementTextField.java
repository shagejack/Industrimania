...
public class ShageElementTextField extends ShageElementBase {
    ...
    public ShageElementTextField(ShageGuiBase gui, ITextHandler textHandler, int posX, int posY, int width, int height) {
        this(gui, textHandler, posX, posY, width, height, (short) 32);
    }

    public ShageElementTextField(ShageGuiBase gui, ITextHandler textHandler, int posX, int posY, int width, int height, short limit) {
    ...
    public ShageElementTextField(ShageGuiBase gui, int posX, int posY, int width, int height) {
        this(gui, gui, posX, posY, width, height);
    }

    public ShageElementTextField(ShageGuiBase gui, int posX, int posY, int width, int height, short limit) {
        this(gui, gui, posX, posY, width, height, limit);
    }

    public ShageElementTextField setTextColor(Number textColor, Number selectedTextColor) {
    ...
    public ShageElementTextField setSelectionColor(Number selectedLineColor, Number defaultCaretColor) {
    ...
    public ShageElementTextField setBackgroundColor(Number backgroundColor, Number disabledColor, Number borderColor) {
    ...
    public ShageElementTextField setMultiline(boolean multi) {
    ...
    public ShageElementTextField setFocused(boolean focused) {
    ...
    public ShageElementTextField setFocusable(boolean focusable) {
    ...
    public ShageElementTextField setText(String text) {
    ...
    public ShageElementTextField setMaxLength(short limit) {
            ...
            default:
                switch (keyTyped) {
                    ...
                    case Keyboard.KEY_RIGHT: // right arrow
                        ...
                        } else if (ShageStringHelper.isAltKeyDown() && GuiScreen.isShiftKeyDown()) {
    ...
    public ShageElementTextField setFilter(Pattern pattern, boolean includeVanilla) {
