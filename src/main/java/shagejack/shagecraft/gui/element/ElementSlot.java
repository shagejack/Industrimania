...
public class ElementSlot extends ShageElementBase {
    ...
    public ElementSlot(ShageGuiBase gui, int posX, int posY, int width, int height, String type, HoloIcon icon) {
    ...
    public ElementSlot(ShageGuiBase gui, int posX, int posY, int width, int height, String type) {
    ...
    public void addTooltip(List<String> list, int mouseX, int mouseY) {
        if (!info.isEmpty()) {
            list.add(ShageStringHelper.translateToLocal(info));
        }
    }
