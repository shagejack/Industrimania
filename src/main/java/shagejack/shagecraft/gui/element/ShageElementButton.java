...
public class ShageElementButton extends ShageElementBase {
    ...
    public ShageElementButton(ShageGuiBase gui, IButtonHandler handler, int posX, int posY, String name, int sheetX, int sheetY, int hoverX, int hoverY, int sizeX, int sizeY, String texture) {
        this(gui, handler, posX, posY, name, sheetX, sheetY, hoverX, hoverY, 0, 0, sizeX, sizeY, texture);
    }

    public ShageElementButton(ShageGuiBase gui, IButtonHandler handler, int posX, int posY, String name, int sheetX, int sheetY, int hoverX, int hoverY, int disabledX, int disabledY, int sizeX, int sizeY, String texture) {
    ...
    public void onMouseReleased(int mouseX, int mouseY) {
        if (isEnabled() && intersectsWith(mouseX, mouseY) && isDown) {
            ...
            if (sound != null) {
                ShageGuiBase.playSound(sound, getSoundVolume(), 0.9f + rand.nextFloat() * 0.2f);
            }
