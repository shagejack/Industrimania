...
public class Reference {
    ...
    public static final String GUI_FACTORY_CLASS = "shagejack.shagecraft.gui.GuiConfigFactory";
    public static final String DEPENDENCIES = "";
    public static final String CHANNEL_NAME = "shagecraft_channel";
    ...
    public static final Color COLOR_SHAGECRAFT = new Color(191, 228, 230);
