...
public class ShageStringHelper {
    ...
    public static boolean hasTranslation(String key) {
        return Shagecraft.PROXY.hasTranslation(key);
    }

    public static String translateToLocal(String key, Object... params) {
        return Shagecraft.PROXY.translateToLocal(key, params);
    }
    ...
    public static String readTextFile(ResourceLocation location) {
        ...
        try {
            ...
            InputStream descriptionStream = ShageStringHelper.class.getResourceAsStream(path);
