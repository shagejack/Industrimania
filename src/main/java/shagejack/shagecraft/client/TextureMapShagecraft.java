...
public class TextureMapShagecraft extends TextureMap {

    public TextureMapShagecraft(String basePathIn) {
        super(basePathIn);
    }

    public TextureMapShagecraft(String basePathIn, @Nullable ITextureMapPopulator iconCreatorIn) {
        super(basePathIn, iconCreatorIn);
    }

    public TextureMapShagecraft(String basePathIn, boolean skipFirst) {
        super(basePathIn, skipFirst);
    }

    public TextureMapShagecraft(String basePathIn, @Nullable ITextureMapPopulator iconCreatorIn, boolean skipFirst) {
    ...
    public void loadTextureAtlas(IResourceManager resourceManager) {
        ...
        LogShage.info("Created: %dx%d %s-atlas", stitcher.getCurrentWidth(), stitcher.getCurrentHeight(), this.basePath);
    ...
    private boolean generateMipmaps(IResourceManager resourceManager, final TextureAtlasSprite texture) {
        ...
        label9:
        {
            ...
            try {
                ...
                LogShage.error("Unable to parse metadata from {}", resourcelocation, runtimeexception);
                flag = false;
            } catch (IOException ioexception) {
                LogShage.error("Using missing texture, unable to load {}", resourcelocation, ioexception);
                flag = false;
                return flag;
            } finally {
                IOUtils.closeQuietly(iresource);
