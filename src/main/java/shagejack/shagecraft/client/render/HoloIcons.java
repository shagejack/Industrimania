package shagejack.shagecraft.client.render;
...
import shagejack.shagecraft.client.TextureMapShagecraft;
...
public class HoloIcons implements ITextureMapPopulator {
    public final TextureMapShagecraft textureMap;
    ...
    public HoloIcons() {
        iconMap = new HashMap<>();
        textureMap = new TextureMapShagecraft("textures/gui/items", this);
        ...
        try {
            ...
            LogShage.log(Level.ERROR, e, "There was a problem while creating Holo Icons texture sheet");
        }
    }
