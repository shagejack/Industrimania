package shagejack.shagecraft.client.model;
...
public class ShageModelLoader implements ICustomModelLoader {
    ...
    public static class MOModelRegistryEvent extends Event {
        private final ShageModelLoader loader;
        private final Map<ResourceLocation, IModel> models;
        private final Type type;

        public MOModelRegistryEvent(ShageModelLoader loader, Map<ResourceLocation, IModel> models, Type type) {
            this.loader = loader;
            this.models = models;
            this.type = type;
        }

        public ShageModelLoader getLoader() {
            return loader;
        }
        ...
        public static class Block extends MOModelRegistryEvent {
            public Block(ShageModelLoader loader, Map<ResourceLocation, IModel> models) {
                super(loader, models, Type.BLOCK);
            }
        }

        public static class Item extends MOModelRegistryEvent {
            public Item(ShageModelLoader loader, Map<ResourceLocation, IModel> models) {
