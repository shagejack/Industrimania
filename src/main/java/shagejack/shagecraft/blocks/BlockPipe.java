...
import shagejack.shagecraft.raytrace.Cuboid;
import shagejack.shagecraft.raytrace.DistanceRayTraceResult;
import shagejack.shagecraft.tile.pipes.TileEntityPipe;
import shagejack.shagecraft.util.AABBUtils;
...
public abstract class BlockPipe<TE extends TileEntity> extends ShageBlockContainer<TE> {
    ...
    public BlockPipe(Material material, String name) {
        ...
        this.setRotationType(ShageBlockHelper.RotationType.PREVENT);
    }
