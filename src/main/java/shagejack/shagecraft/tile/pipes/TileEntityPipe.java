...
public abstract class TileEntityPipe extends ShageTileEntity implements ITickable {
    ...
    public void setConnection(EnumFacing connection, boolean value) {
        this.connections = ShageMathHelper.setBoolean(connections, connection.ordinal(), value);
        markDirty();
    }

    public boolean isConnectedFromSide(EnumFacing enumFacing) {
        return ShageMathHelper.getBoolean(connections, enumFacing.ordinal());
    }
    ...
    public boolean isConnectableSide(EnumFacing dir) {
        return ShageMathHelper.getBoolean(connections, dir.ordinal());
    }
