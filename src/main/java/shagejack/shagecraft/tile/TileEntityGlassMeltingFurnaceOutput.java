...
public class TileEntityGlassMeltingFurnaceOutput extends ShageTileEntityMachine implements IShageTickable, ITickable {

    public GlassMeltingFurnaceTank tank;

    public TileEntityGlassMeltingFurnaceOutput() {
        super();
        this.tank = new GlassMeltingFurnaceTank(null, Fluid.BUCKET_VOLUME * 4);
