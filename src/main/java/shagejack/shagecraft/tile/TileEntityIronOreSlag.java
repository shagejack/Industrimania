...
public class TileEntityIronOreSlag extends ShageTileEntity implements IShageTickable, ITickable {
    ...
    public ItemStack getRealIronDrop(){
        ...
        if(perMass * count > 0) {
            ...
            ironStack = new ItemStack(Shagecraft.ITEMS.iron_cluster);
            Shagecraft.ITEMS.iron_cluster.setMass(ironStack, perMass * count);
            Shagecraft.ITEMS.iron_cluster.setCarbon(ironStack, 0.02 + fortune * 0.01);
            Shagecraft.ITEMS.iron_cluster.setTemp(ironStack, 298.15);
            Shagecraft.ITEMS.iron_cluster.setImpurities(ironStack, 60  * (0.05 + mol_Impurities));
            Shagecraft.ITEMS.iron_cluster.setShape(ironStack, shape);
            return ironStack;
        }
    ...
    public ItemStack getRealSlagDrop(){
        ...
        ironStack = new ItemStack(Shagecraft.ITEMS.slag, fortuneCount);
